...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Set specific screen size found in settings
    ...
    def _update_aliens(self):
        ...
        # Look fro alien-ship collisions.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat as same as ship getting hit by alien
                self._ship_hit()
                break
    ...
    def _create_fleet(self):
        ...
        #Make an alien and find the number that can fit in a row on screen
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any aliens reach screen edge"""
        for alien in self.aliens.sprites():
